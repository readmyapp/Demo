...
export const HeroFuturistic = () => {
  ...
  return (
    <div className="h-screen relative">
        ...
        <div className="text-xs md:text-xl xl:text-2xl 2xl:text-3xl mt-2 overflow-hidden text-white font-bold">
          <div
            ...
            style={{ 
              ...
              transitionDelay: `${titleWords.length * 130 + 200}ms`
            }}
          >
            {subtitle}
          </div>
      ...
      <button
        className="absolute bottom-10 left-1/2 transform -translate-x-1/2 bg-transparent border border-white/30 text-white px-6 py-3 rounded-full hover:bg-white/10 transition-all duration-300 flex items-center space-x-2 z-50"
        style={{ animationDelay: '2.2s' }}
      >
        <span>Scroll to explore</span>
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="animate-bounce">
